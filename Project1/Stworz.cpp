...
void Stworz::Edytuj()
{
	...
	size_t maxTextLength = 50; //Maksymalna d³ugoœæ wpisywanego tekstu
	...
	//Wyjœcie z quizu
	Ustawienia_tekstu(wyjdz, *czcionka, 25, 1, Color::Blue, L"WyjdŸ");
	...
	//Usuñ pytanie
	Ustawienia_tekstu(usun_pytanie, *czcionka, 25, 1, Color::Blue, L"Usuñ pytanie");
	...
	while (okno->isOpen() && tworzenie)
	{
		...
		ilosc_pytan_tekst.setString(L"Iloœæ pytañ: " + to_string(ilosc_pytan));
...
void Stworz::Dodaj_Pytanie()
{
	...
	{
		//Odpowiedzi
		Ustawienia_tekstu(pytania.odpowiedz[j], *czcionka, 45, 0, Color::Blue, L"Przyk³adowa odpowiedŸ");
