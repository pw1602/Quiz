...
void Quiz::Rozpocznij_Quiz()
{
	...
	//Wyjœcie z quizu
	Ustawienia_tekstu(wyjdz_z_quizu, *czcionka, 25, 1, Color::Blue, L"WyjdŸ z Quizu");
...
bool Quiz::Ilosc_Pytan()
{
	...
	//--------------------------------------------------Ustawienia tekstu--------------------------------------------------
	Ustawienia_tekstu(tekst2, *czcionka, 25, 0, Color::White, "Wybierz iloœæ pytañ:");
	tekst2.setPosition(okno->getSize().x / 2 - tekst2.getGlobalBounds().width / 2, 200);

	Ustawienia_tekstu(tekst, *czcionka, 25, 0, Color::White, "Lub podaj iloœæ pytañ:");
